        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl opacity-90 mb-8">
              Can&apos;t find what you&apos;re looking for? Let us source your
              dream car for you.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gray-50 p-8 rounded-xl text-center">
              ...
              <p className="text-gray-600">
                We leverage our extensive international network to source rare
            ...
            <div className="bg-gray-50 p-8 rounded-xl text-center">
              ...
              <p className="text-gray-600">
                Tell us exactly what you need, from interior features to engine
                specifications.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl text-center">
              ...
              <p className="text-gray-600">
                We don&apos;t stop until we find exactly what you&apos;re
              ...
              {submitSuccess ? (
                <div className="text-center py-8">
                  <div className="bg-green-100 text-green-800 p-4 rounded-xl mb-6">
                    ...
                    <p>
                      Thank you for your custom order request. Our team will
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-gray-300 flex items-center justify-center mr-4">
                  <span className="text-xl font-bold text-gray-600">PO</span>
                </div>
                <div>
                  <h4 className="font-bold">Patrick Obinna</h4>
                  <p className="text-sm text-gray-600">Lexus IS 350</p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="font-bold">Anderson Amadi</h4>
                  <p className="text-sm text-gray-600">Hyundai sonata</p>
                </div>
              </div>
              <p className="text-gray-700">
                I was searching for a specific Sonata model with unique
                specifications. The team quickly found exactly what I wanted.
                Incredible service!
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Toyota Corolla 2019</p>
                </div>
              </div>
              <p className="text-gray-700">
                The custom order process was smooth. They kept me informed
                throughout and delivered a car that surpassed my expectations.
              </p>
              <p className="text-sm text-gray-600">
                Rivers, Nigeria. Port Harcourt, Nigeria
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700">
                Yes, we require a refundable deposit of 10% of the estimated
                vehicle cost to begin the search process. This deposit is fully
                refundable if we&apos;re unable to find a vehicle that meets
                your specifications.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                Can you source vehicles from overseas?
              </h3>
              <p className="text-gray-700">
                Absolutely! Our global network allows us to source vehicles from
                Europe, Asia, America, and other international markets. We
                handle all import logistics and ensure the vehicle meets local
                regulations.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-2">
                What if I&apos;m not satisfied with the vehicle?
              </h3>
              <p className="text-gray-700">
                Customer satisfaction is our top priority. Before finalizing any
                purchase, we provide detailed information and images of the
                vehicle. If the vehicle does not meet your expectations upon
                delivery, we offer a satisfaction guarantee.{" "}
              </p>
            </div>
          </div>
        </div>
